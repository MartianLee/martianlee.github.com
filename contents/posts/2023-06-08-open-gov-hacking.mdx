...
![정보공개포털 정보목록 이미지](../images/2023-06-08-open-gov-hacking/share-page1.png)
...
![정보공개포털 정보목록 이미지](../images/2023-06-08-open-gov-hacking/share-page2.png)
정보 목록 중 하나를 선택해 페이지를 이동하고 주소창을 자세히 보면

![정보공개포털 정보목록 주소](../images/2023-06-08-open-gov-hacking/share-page3.png) 그
...
![정보공개포털 정보목록 주소](../images/2023-06-08-open-gov-hacking/share-page9.png)

아니 이럴수가... 페이지를 불러오는 요청이 GET이 아니라 POST 였던 것이었습니다.

아직 공공기관 페이지와 친하지 않은 저는 벌써 어떻게 해야 하지 눈앞이 하얗게 되었습니다.

![정보공개포털 정보목록 주소](../images/2023-06-08-open-gov-hacking/share-page4.png)
...
![정보공개포털 정보목록 주소](../images/2023-06-08-open-gov-hacking/share-page5.png)

페이로드에서 '소스 보기'를 누르고 기존 `https://www.open.go.kr/othicInfo/infoList/infoListDetl2.do` 주소 뒤에 ? (물음표)를 붙여준 뒤 쿼리 파라미터를 입력해 줍니다.

![정보공개포털 정보목록 주소](../images/2023-06-08-open-gov-hacking/share-page6.png)
![정보공개포털 정보목록 주소](../images/2023-06-08-open-gov-hacking/share-page7.png)

(드래그 해서 복사하는 중)

![정보공개포털 정보목록 주소](../images/2023-06-08-open-gov-hacking/share-page8.png)
