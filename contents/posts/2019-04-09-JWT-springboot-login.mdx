...
![img1](./contents/190409_JWT-springboot-login/token.png)
토큰을 잘 반환되는 것을 확인할 수 있습니다.

![img2](./contents/190409_JWT-springboot-login/token2.png)
반환된 토큰을 (클라이언트에서는 쿠키에 저장해서 보낸다고 생각하고) Autorization의 Bearer Token을 선택하고 입력해 줍니다.

![img3](./contents/190409_JWT-springboot-login/token3.png)
