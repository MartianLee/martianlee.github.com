...
I will call that difference the **magic tax**. In everyday terms it is a premium. Rails hands you migrations, callbacks and `post.user` in a single line, and the Rails premium is what that convenience costs.
